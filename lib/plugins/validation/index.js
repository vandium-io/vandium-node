...
function getMethodSchema( value ) {
    ...
    for( let section in value ) {
        ...
        methodSchema[ section ] = validation.createSchema( sectionSchemaDef );
    }
...
function buildSchema( schema, lambdaProxy, lambdaProxyAny ) {
    ...
    if( lambdaProxy === true ) {
        ...
        return validation.createSchema( schema );
    }
}
        ...
        try {
            ...
            if( this.lambdaProxy ) {
                ...
                for( let section in schema ) {
                    ...
                    updated[ section ] = validation.validate( sectionValues, schema[ section ], this.options );
                }
            }
            else {
                ...
                updated = validation.validate( values, schema, this.options );
            }
