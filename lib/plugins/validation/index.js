    ...
    if( lambdaProxy === true ) {
        ...
        for( let key in schema ) {
            ...
            if( utils.isObject( value ) ) {
                ...
                proxySchema[ key ] = createSchema( value );
            }
        }
...
class ValidationPlugin extends Plugin {
    ...
    execute( pipelineEvent, callback ) {
        ...
        if( this.lambdaProxy && schema ) {
            ...
            schema = this.configuredSchema[ pipelineEvent.httpMethod ];
        }
        ...
        try {
            ...
            let updated = validationProvider.validate( values, schema, this.options );
