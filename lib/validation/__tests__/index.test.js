...
describe( 'lib/validation/index', function() {
    ...
    describe( '.createSchema', function() {
        ...
        it( 'normal operation', function() {
            ...
            const schema = validation.createSchema( schemaConfig );

            expect( Joi.isSchema( schema ) ).to.be.true;

            expect( schema._ids._byKey.get( 'firstName' ) ).to.exist;
            expect( schema._ids._byKey.get( 'lastName' ) ).to.exist;
            expect( schema._ids._byKey.get( 'favorite' ) ).to.exist;
        });
    ...
    describe( '.createArrayBasedSchema', function() {
        ...
        it( 'normal operation', function() {
            ...
            let schema = validation.createArrayBasedSchema( schemaConfig );
