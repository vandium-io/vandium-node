...
class Handler {
    ...
    addMethodsToHandler( lambdaHandler ) {
        ...
        this.addlambdaHandlerMethod( 'resource', lambdaHandler );
    ...
    memory( m ) {
        ...
        return this._configure( { memory: m }, true );
    }

    timeout( t ) {

        return this._configure( { timeout: t }, true );
    }

    role( r ) {

        return this._configure( { role: r }, true );
    }

    resource( r ) {

        return this._configure( { resource: r }, true );
    }

    _configure( config, preserve ) {
    ...
    appendConfiguration( config ) {
        ...
        return this._configure( config, true );
    }
