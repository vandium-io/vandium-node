...
class APIHandler extends TypedHandler {
    ...
    authorization( { tokenPath = 'headers.Authorization', ...authConfig } = {} ) {

        this._jwt = new JWTValidator( { ...authConfig, tokenPath } );
    ...
    _initPipeline() {
        ...
        this.pipeline.setStage( 'methodValidation', (state) => {
        ...
        this.pipeline.setStage( 'eventNormalization', (state) => {
        ...
        this.pipeline.setStage( 'bodyProcessing', (state) => {
        ...
        this.pipeline.setStage( 'protection', (state) => {
        ...
        this.pipeline.setStage( 'cookies', (state) => {
        ...
        this.pipeline.setStage( 'jwt', (state) => {
        ...
        this.pipeline.setStage( 'validation', (state) => {

            const { event, extra: { methodHandler } } = state;

            methodHandler.validator.validate( event );
        });

        this.pipeline.setStage( 'extractExecutor', (state) => {
