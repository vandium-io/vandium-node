    ...
    describe( 'Protection', function() {
        ...
        describe( 'constructor', function() {
            ...
            it( 'no options', function() {
                ...
                expect( instance.sections ).to.eql( [ 'queryStringParameters',
                    'multiValueQueryStringParameters', 'body', 'pathParameters' ] );
            });
        ...
        describe( '.validate', function() {
            ...
            it( 'with sql and mongodb mode option, selective', function() {

                let instance = new Protection( {

                    mode: 'fail',
                    sql: 'report',
                    queryStringParameters: false,       // skip queryStringParameters
                });
                ...
                let event = {
                    ...
                    muliValueQueryStringParameters: {
                ...
                expect( instance.sql.scan.calledOnce ).to.be.true;
                expect( instance.sql.scan.firstCall.args ).to.eql( [{ body1: 'b1', body2: 'b2' }] );

                expect( instance.mongodb.scan.calledOnce ).to.be.true;
                expect( instance.mongodb.scan.firstCall.args ).to.eql( [{ body1: 'b1', body2: 'b2' }] );
            });
        });
    });
});
