...
const { api : apiHandler } = require( '../index' );
...
describe( MODULE_PATH, function() {
    ...
    describe( 'handler', function() {
        ...
        it( 'normal operation', async function() {
            ...
            const event = require( './put-event.json' );
        ...
        it( 'normal operation with separate validation and handler', async function() {
            ...
            handler.PUT()
                .validation( ( types ) => ({
                    ...
                    body: {
                        ...
                        name: types.string().trim().required(),
                    },
        ...
        it( 'normal operation, with result containing a Buffer instance, header', async function() {
