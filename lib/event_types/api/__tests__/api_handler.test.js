    ...
    describe( 'APIHandler', function() {
        ...
        describe( '.authorization', function() {
            ...
            it( 'normal operation', function() {
                ...
                let returnValue = instance.authorization( {
            ...
            it( 'called without arguments', function() {
                ...
                expect( instance.authorization.bind( instance ) ).to.throw( 'authentication error: missing algorithm' );
            });
            ...
            it( 'called with false', function() {
                ...
                const returnValue = instance.authorization( false );
        ...
        describe( '.jwt', function() {
            ...
            it( 'called without arguments', function() {
                ...
                expect( instance.jwt.bind( instance ) ).to.throw( 'authentication error: missing algorithm' );
            });
        ...
        describe( '.executePreprocessors', function() {
            ...
            it( 'request with bad cookies', function() {
                ...
                state.event.headers = { ...state.event.headers, Cookie: 'bad-cookie!' };
