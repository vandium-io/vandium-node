...
describe( 'lib/event_types/typed', function() {
    ...
    describe( '.executePreprocessors', function() {
        ...
        it( 'non-matching event subtype', function() {

            let instance = new TypedHandler( 'whatever' );
            instance.matchSubType( 'special-thing' );
            ...
            eventIdentifierStub.identify.returns( { type: 'whatever', source: 'thing' } );

            expect( instance.executePreprocessors.bind( instance, state ) ).to.throw( 'Expected event source of special-thing but identified as thing' );
