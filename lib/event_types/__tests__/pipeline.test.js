...
describe( 'lib/event_types/pipeline', function() {
    ...
    describe( 'Pipeline', function() {
        ...
        describe( 'constructor', function() {
            ...
            it( 'normal operation', function() {
                ...
                expect( instance.handlers.size ).to.equal( 2 );
            });
        });
        ...
        describe( '.stage', function() {
            ...
            it( 'normal operation', function() {
                ...
                expect( instance.handlers.get( 'two' ) ).to.eql( myHandler );
            });
    ...
    describe( 'PipelineExecutorSync', function() {
        ...
        describe( '.run', function() {
            ...
            it( 'with hooks', function() {

              const instance = new Pipeline( [ 'one', 'two', 'three' ] );

              const oneHandler = sinon.stub().returns( 1 );

              const threeHandler = sinon.stub().returns( 3 );

              instance.stage( 'one', oneHandler );
              instance.stage( 'three', threeHandler );
              ...
              const result = executor.run( state );

              expect( oneHandler.called ).to.be.false;
              ...
              expect( threeHandler.called ).to.be.true;
              expect( state.hooks.one.stub.called ).to.be.true;
              expect( state.hooks.three.before.called ).to.be.true;
              expect( state.hooks.three.after.called ).to.be.true;
            });
